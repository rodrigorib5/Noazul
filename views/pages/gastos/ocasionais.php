...
$gastosOcasionais = $gastoController->getTipoGastoAberto(AppUtil::GASTO_OCASIONAL);
$valorTotal = null;
?>
                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover"
                            ...
                            <tbody>
                            <?php foreach ($gastosOcasionais as $gasto){   
...
<form method="post" id="gasto-fixo">
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Novo Gasto Ocasional</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name="tipo-gasto" value="3">
